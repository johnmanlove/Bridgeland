...
function eme_options_register() {
   ...
   switch ( $tab ){
	      ...
	      case 'events' :
	         ...
	         break;
	      case 'calendar' :
                 $options = array ('eme_small_calendar_event_title_format','eme_small_calendar_event_title_separator','eme_full_calendar_event_format','eme_cal_hide_past_events');
	         break;
	      case 'locations' :
