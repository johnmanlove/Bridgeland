...
<div id="footer" class="clearfix">
	...
	<div id="footer-social" class="clearfix">
		<div class="logo">
                <a href="/"><img src="/wp-content/uploads/2015/09/logo.png" alt="Bridgeland"></a>
        </div>
        <div class="social-links">
            <ul>
                ...
                <li><a id="maps" href="http://bl.vismark.us/DTS/lots/eplats/index_base.asp" target="_blank">Interactive Maps</a></li>
            </ul>
        </div>
	</div>
